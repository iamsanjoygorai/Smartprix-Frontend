...
async function handleRemoveProfileImage() {
  ...
  // If the image was only selected locally and has not been saved yet,
  ...
  try {
    ...
    // Notify header/profile components.
...
async function handleSubmit(
  ...
  try {
    ...
    /* =====================================================
       PROFILE IMAGE
       Only send when a NEW image was selected.
    ===================================================== */
    ...
    if (!updatedUser) {
      setError(
        "Profile was updated, but no updated profile was returned.",
      );
      return;
    }
