...
return ( <AdminPermissionGuard permission="news.create"> <div className="min-h-screen bg-[#f1f1f1] text-[#1d2327]">
{/* =====================================================
PAGE HEADER
===================================================== */}
            ...
            <div className="p-3">
              ...
              {showPublishSettings && (
                <AdminPermission
                  permission="news.publish"
                  fallback={
                    <p className="mt-3 border-t border-[#eee] pt-3 text-xs text-gray-500">
